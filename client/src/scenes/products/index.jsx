        ...
        <Card
            ...
            <Collapse
                ...
                <CardContent>
                    ...
                    <Typography>Yearly Sales This Year: {stat.yearlySales}</Typography>
...
const Products = () => {
    ...
    // product
    const { data: productData, isSuccess: productSuccess } = useGetProductsQuery()

    let product;

    if (productSuccess) {
        product = productData.productsWithStat
