...
const Transactions = () => {
    ...
    const { data: transactionData, isSuccess, isLoading } = useGetTransactionsQuery({
        page,
        pageSize,
    ...
    return (
        <Box m="1.5rem 2.5rem">
            ...
            {isSuccess ? <Box mt="20px" height="80vh"
                sx={{
                    "& .MuiDataGrid-root": {
                        border: "none"
                    },
                ...
                <DataGrid
                    ...
                    onSortModelChange={(newSortModel) => setPageSize(...newSortModel)}
