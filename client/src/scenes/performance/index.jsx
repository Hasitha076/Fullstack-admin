...
const Performance = () => {
    ...
    console.log(userId)
    const { data, isLoading, isSuccess } = useGetPerformanceQuery(userId)

    let performance;

    if (isSuccess) {
        performance = data
        console.log("All performance: ", performance)
    }
    ...
    return (
        <Box m="1.5rem 2.5rem">
            ...
            {isSuccess ? <Box mt="20px" height="75vh"
                sx={{
                    "& .MuiDataGrid-root": {
                        border: "none"
                    },
            ...
            >
                <DataGrid
                    ...
                    rows={(performance && performance.sales) || []}
                    columns={columns}
